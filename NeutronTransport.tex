...
\subsubsubsection{Incoming Flux}
...
\frac{1}{v(E)} \frac{\partial\vv{J}\spas}{\partial t} +
 ...
 \int_{4\pi}^{} d\hO   \int_{0}^{\infty}dE' \int_{4\pi}^{ } d\hO  ' \hO  \Sigma_s(\vv{r}, E'\rightarrow E, \hO  '\rightarrow\hO  )\psi\spap + \int_{4\pi}^{} d\hO  \hO  S\spa \\
\end{aligned}
\end{equation}
...
\frac{1}{v(E)} \frac{\partial\vv{J}\spas}{\partial t} +
 \nabla\cdot \int_{4\pi}^{} d\hO   \hO  \hO  \psi\spa  + 
 \Sigma_t(\vv{r},E)\vv{J}\spas = \\
 \int_{4\pi}^{} d\hO   \int_{0}^{\infty}dE' \int_{4\pi}^{ } d\hO  ' \hO  \cdot\hO   \hO  \Sigma_s(\vv{r}, E'\rightarrow E, \hO  '\rightarrow\hO  )\psi\spap + \vv{S_1}\spas\\
\end{aligned}
\end{equation}
...
\phi\spas = \phi_0 + \frac{3}{4\pi}\phi_1\int_{4\pi}^{} d\hO  \hO   = \phi_0
\end{aligned}
\end{equation}
